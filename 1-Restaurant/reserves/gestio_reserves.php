...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax'])) {
    ...
    $sql = "SELECT id_reserva, estat_reserva, id_taula, nom_client, data_reserva, hora_reserva, num_persones FROM reserves WHERE 1=1";
...
//     }
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo '<thead><tr><th>ID</th><th>Estat</th><th>Taula</th><th>Client</th><th>Data</th><th>Hora</th><th>Persones</th></tr></thead><tbody>';
