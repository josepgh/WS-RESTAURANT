...
//======================================================================================================================
insertaEnPersonal('Carla ADM', 'administrador', 'administrador1', 'administrador1', 'localhost', TRUE);
insertaEnPersonal('Teresa ADM', 'administrador', 'administrador2', 'administrador2', 'localhost', TRUE);
insertaEnPersonal('Anna ADM', 'administrador', 'administrador3', 'administrador3', 'localhost', TRUE);
//======================================================================================================================
insertaEnPersonal('Antonia CUI', 'cuiner', 'cuiner1', 'cuiner1', 'localhost', TRUE);
insertaEnPersonal('Kevin José CUI', 'cuiner', 'cuiner2', 'cuiner2', 'localhost', TRUE);
insertaEnPersonal('Natàlia CUI', 'cuiner', 'cuiner3', 'cuiner3', 'localhost', TRUE);
//======================================================================================================================
insertaEnPersonal('Vanessa CAM', 'cambrer', 'cambrer1', 'cambrer1', 'localhost', TRUE);
insertaEnPersonal('Carlos Jesús CAM', 'cambrer', 'cambrer2', 'cambrer2', 'localhost', TRUE);
insertaEnPersonal('Joan CAM', 'cambrer', 'cambrer3', 'cambrer3', 'localhost', TRUE);
//======================================================================================================================
...
<body>
    ...
    <div class="centrat">
		...
		<h2>REGISTRES INSERITS CORRECTAMENT A LES TAULES</h2>        
