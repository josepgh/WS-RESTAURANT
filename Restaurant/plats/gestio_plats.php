            ...
            <form class="modal-content" id="formAfegir">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="preu" step="0.1" min="0" class="form-control" required>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content" id="formEditar">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Preu</label>
                        <input type="number" name="preu" id="edit_preu" step="0.1" min="0" class="form-control" required>
                    </div>
                    <!--<div class="mb-3"> -->
