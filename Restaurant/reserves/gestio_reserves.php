<?php
session_start();
if ($_SESSION['rol'] == 'cambrer' || $_SESSION['rol'] == 'administrador' ){
    ...
    <?php 
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($r = $result->fetch_assoc()) {
                ...
                echo "<button type='submit' class='btn btn-sm btn-success'>Iniciar COMANDA</button>";
                echo "</form>";
                echo "</td><td>";
                
                echo "<a href='../comandes/comandes_view.php?nom_client=" . $r['nom_client']
                . "' class='btn btn-sm btn-success' role='button'>Com VIEW</a>";
                echo "</td></tr>";
            }
            echo '</tbody></table>';
        } else {
